...
#ifndef HOLOSCAN_OPERATORS_AJA_SOURCE_MULTI_CH_AJA_SOURCE_HPP
#define HOLOSCAN_OPERATORS_AJA_SOURCE_MULTI_CH_AJA_SOURCE_HPP
 ...
 *   (default: `true`).
 */
class AJASourceMultiChannelOp : public holoscan::Operator {
 public:
  HOLOSCAN_OPERATOR_FORWARD_ARGS(AJASourceMultiChannelOp)

  AJASourceMultiChannelOp();
...
#endif /* HOLOSCAN_OPERATORS_AJA_SOURCE_MULTI_CH_AJA_SOURCE_HPP */
