...
channels : list[holoscan.operators.NTV2Channel], optional
    The camera ``NTV2Channel`` list to use for output. The first channel in the list will be used as the
    active channel.
    Examples: ``[NTV2Channel.NTV2_CHANNEL1, NTV2Channel.NTV2_CHANNEL2]``.
    Default value is ``[NTV2Channel.NTV2_CHANNEL1]``.
width : int, optional
...
enable_overlay : bool, optional
    ...
    (``"false"`` in YAML).
overlay_channels : list[holoscan.operators.NTV2Channel], optional
    The camera NTV2Channel list to use for overlay output. The first channel in the list will be used as the
    active overlay channel.
    Examples: ``[NTV2Channel.NTV2_CHANNEL3, NTV2Channel.NTV2_CHANNEL4]``.
    Default value is ``[NTV2Channel.NTV2_CHANNEL3]``.
