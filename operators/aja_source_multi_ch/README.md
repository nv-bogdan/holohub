...
| `channels` | vector<NTV2Channel> | List of camera channels to use for input (first channel is active) | [NTV2_CHANNEL1] |
...
| `overlay_channels` | vector<NTV2Channel> | List of camera channels to use for overlay (first channel is active) | [NTV2_CHANNEL3] |
